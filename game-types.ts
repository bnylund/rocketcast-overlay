// https://raw.githubusercontent.com/zipsesportsnetwork/sos-wrapper/master/types.ts

export type GameEvent = keyof EventDataMap
...
export type EventDataMap = {
  ...
  'game:statfeed_event': {
     ...
     * AKA receiver
     */
    main_target: BasePlayer & { team_num: TeamNumber }
    /**
     * AKA victim
     */
    secondary_target: BasePlayer & { team_num: TeamNumber }
    /**
     * e.g. `"Goal"`
     */
    type: string
